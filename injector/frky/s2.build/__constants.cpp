...
static void _createGlobalConstants(void) {
    ...
    Nuitka_SysSetObject(
        ...
        global_constants[72]
#else
        getStandaloneSysExecutablePath(global_constants[72])
#endif
    );
    ...
    PyStructSequence_SET_ITEM(Nuitka_dunder_compiled_value, 1, PyInt_FromLong(0));

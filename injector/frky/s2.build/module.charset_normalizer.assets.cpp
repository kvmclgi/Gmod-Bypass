...
static PyCodeObject *codeobj_a6407ee2bb24f3882ed0a49965115e85;

static void createModuleCodeObjects(void) {
    module_filename_obj = MAKE_RELATIVE_PATH(mod_consts[22]); CHECK_OBJECT(module_filename_obj);
    codeobj_a6407ee2bb24f3882ed0a49965115e85 = MAKE_CODEOBJECT(module_filename_obj, 1, CO_NOFREE, mod_consts[23], NULL, NULL, 0, 0, 0);
}
...
// Mark the execution in the "__spec__" value.
    ...
    struct Nuitka_FrameObject *frame_a6407ee2bb24f3882ed0a49965115e85;
    ...
    // Frame without reuse.
    frame_a6407ee2bb24f3882ed0a49965115e85 = MAKE_MODULE_FRAME(codeobj_a6407ee2bb24f3882ed0a49965115e85, module_charset_normalizer$assets);

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack(frame_a6407ee2bb24f3882ed0a49965115e85);
    assert(Py_REFCNT(frame_a6407ee2bb24f3882ed0a49965115e85) == 2);
    ...
    // Framed code:
    {
        ...
        frame_a6407ee2bb24f3882ed0a49965115e85->m_frame.f_lineno = 1;
        {
...
#if 0
    RESTORE_FRAME_EXCEPTION(frame_a6407ee2bb24f3882ed0a49965115e85);
#endif
    popFrameStack();

    assertFrameObject(frame_a6407ee2bb24f3882ed0a49965115e85);
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_a6407ee2bb24f3882ed0a49965115e85, exception_lineno);
    } else if (exception_tb->tb_frame != &frame_a6407ee2bb24f3882ed0a49965115e85->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_a6407ee2bb24f3882ed0a49965115e85, exception_lineno);
    }
